...
export default function DetalheComunicadoPage({ params }: Props) {
    ...
    return (
      <main className="pagina">
        <div className="hero">
          ...
          <p>O aviso que você tentou acessar não existe ou foi removido.</p>
        </div>

        <Link href="/comunicados-gerais" style={{ textDecoration: "none", color: "inherit" }}>
          <button className="botao">Voltar para comunicados</button>
        </Link>
      </main>
    );
  }
