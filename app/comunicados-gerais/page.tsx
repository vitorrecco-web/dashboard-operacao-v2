...
export default function ComunicadosGeraisPage({ searchParams }: Props) {
  ...
  const [filtroLeitura, setFiltroLeitura] = useState<"todos" | "lidos" | "nao-lidos">("todos");
  ...
  const tagsDisponiveis = [
    TODAS_AS_TAGS,
    ...Array.from(new Set(comunicados.map((c) => c.tag))),
  ];
  ...
  const comunicadosFiltrados = useMemo(() => {
    return comunicados.filter((item) => {
      ...
      if (tagSelecionada !== TODAS_AS_TAGS && item.tag !== tagSelecionada) return false;
  ...
  return (
    <main className="pagina">
      ...
      <div className="hero" style={{ marginBottom: "28px" }}>
        ...
        <p>
          Consulte os avisos mais recentes da operação e acompanhe atualizações importantes.
        </p>
      </div>
      ...
      >
          ...
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
            <button
              ...
              style={{
                ...
                outline: filtroLeitura === "todos" ? "2px solid #7dd3fc" : "none",
              }}
            >
              Todos
            </button>
            ...
            <button
              ...
              style={{
                ...
                outline: filtroLeitura === "lidos" ? "2px solid #7dd3fc" : "none",
              }}
            >
              Lidas
            </button>
            ...
            <button
              ...
              style={{
                ...
                outline: filtroLeitura === "nao-lidos" ? "2px solid #7dd3fc" : "none",
              }}
            >
              Não lidas
            </button>
        ...
        {comunicadosFiltrados.length === 0 ? (
          ...
          >
            ...
            <p>Não há comunicados disponíveis para esse filtro no momento.</p>
          </div>
        ) : (
